        ...
        <div id="wrapper">
                ...
                <div class="aside-content-wrapper">
                    ...
                    <div class="aside-content">
                        ...
                        <ul class="nav flex-column custom-scrollbar" id="sidenav" data-children=".nav-item">
                                ...
                                <ul id="collapse-dashboards"
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link ripple " href="apps-dashboards-project.html"
                                           data-page-url="/apps-calendar.html">
                            ...
                            <li class="nav-item">
                                <a class="nav-link ripple active" href="apps-calendar.html"
                                   data-page-url="/apps-calendar.html">
            ...
            <div class="content-wrapper">
                ...
                <div class="content">
                        ...
                        <div class="page-header bg-primary text-auto p-6">
                            ...
                            <div class="header-content d-flex flex-column justify-content-between">
                                ...
                                <div class="header-bottom row align-items-center justify-content-center">
                                    ...
                                    <button id="calendar-next-button" type="button" class="btn btn-icon"
                                            aria-label="Next">
                    ...
                    <link type="text/css" rel="stylesheet"
                          href="../assets/vendor/fullcalendar/dist/fullcalendar.print.min.css"
                          media="print"/>

                    <script type="text/javascript" src="../assets/vendor/moment/min/moment.min.js"></script>
                    <script type="text/javascript"
                            src="../assets/vendor/fullcalendar/dist/fullcalendar.min.js"></script>
                    <script type="text/javascript" src="../assets/js/apps/calendar/calendar.js"></script>
                </div>
